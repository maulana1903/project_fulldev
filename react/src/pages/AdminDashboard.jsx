...
export default function AdminDashboard() {
  ...
  const updateStatus = async (row, status) => {
    const confirm = await Swal.fire({
      ...
      text:
        status === "disetujui"
          ? "Service akan disetujui dan diproses"
          : "Service akan ditolak dan tidak diproses",
      icon: "warning",
      showCancelButton: true,
      confirmButtonText: "Ya",
      cancelButtonText: "Batal",
      confirmButtonColor:
        status === "disetujui" ? "#198754" : "#dc3545",
    });
...
Terima kasih`
  ...
  useEffect(() => {
    document.body.classList.add(
      "sidebar-mini",
      "layout-fixed",
      "sidebar-collapse" // default HP tertutup
    );
          ...
          <div className="container-fluid">
            ...
            <div className="mb-3 col-md-4">
              <input
                ...
                placeholder="Cari nama / no WA / status..."
                value={search}
                          ...
                          {row.status === "menunggu" ? (
                            <>
                              <button
                                ...
                                onClick={() => updateStatus(row, "disetujui")}
                              >
                                ACC
                              </button>
                              <button
                                className="btn btn-sm btn-danger"
                                onClick={() => updateStatus(row, "ditolak")}
                              >
                                Tolak
                              </button>
                            </>
