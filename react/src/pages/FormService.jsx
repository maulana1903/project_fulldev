        ...
        <div className="container-fluid">
          <ul className="navbar-nav">
            <li className="nav-item d-none d-md-block">
              <a href="https://api.whatsapp.com/send?phone=6285868598956&text=Halo%20kak%20👋%20saya%20mau%20konsultasi" target="_blank" rel="noopener noreferrer" className="nav-link">
                Contact
              </a>
            </li>
          </ul>
              ...
              <div className="col-md-12">
                <div className="card card-primary card-outline mb-4">
                  <div className="card-header">
                    <div className="card-title">Form Daftar Service On The Spot</div>
                  </div>
                    ...
                    <div className="card-body">
                      <div className="row g-3">
                        <div className="col-md-6">
                          ...
                          <input type="text" name="nama_pemilik" className="form-control" required />
                          <div className="invalid-feedback">Nama wajib diisi</div>
                        </div>

                        <div className="col-md-6">
                          <label className="form-label">Alamat Lengkap</label>
                          <input type="text" name="alamat" className="form-control" required />
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="input-group">
                            ...
                            <input type="number" name="no_telp" className="form-control" required />
                            <div className="invalid-feedback">Nomor WA wajib diisi</div>
                          </div>
                        </div>

                        <div className="col-md-6">
                          <label className="form-label">Tanggal Service</label>
                          <input type="date" name="tanggal_service" className="form-control" min={today} max={maxDate} required />
                          <div className="invalid-feedback">Pilih tanggal service</div>
                        </div>
                        ...
                        <div className="col-md-6">
                          ...
                          />
                          <div className="invalid-feedback">Jam service wajib diisi</div>
                        </div>

                        <div className="col-md-6">
                          <label className="form-label">Link Google Maps</label>
                          <input type="text" name="gmaps" className="form-control" value={map.link || ''} readOnly required />
                          <div className="invalid-feedback">Pilih lokasi di peta</div>
                        </div>

                        <div className="col-12">
                          <label className="form-label">Pilih Lokasi di Maps</label>
                          <MapPicker setData={setMap} />
                        </div>

                        <div className="col-md-6">
                          <label className="form-label">Kerusakan</label>
                          <input type="text" name="keterangan" className="form-control" required />
                          <div className="invalid-feedback">Masukkan kerusakan</div>
                        </div>
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="invalid-feedback">Upload bukti transfer</div>
                        </div>

                        <div className="col-12">
                          <div className="form-check">
                            <input className="form-check-input" type="checkbox" required />
                            <label className="form-check-label">Saya menyetujui syarat & ketentuan</label>
                            <div className="invalid-feedback">Wajib disetujui</div>
                          </div>
                        </div>
                      </div>
                    </div>
